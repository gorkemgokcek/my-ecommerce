...
export default function Pagination() {
  return (
    <div className="flex w-[1413px] h-[74px] justify-center items-center ">
      <button
      ...
      <button
        ...
        type="button"
      >
        <span className="absolute transform -translate-x-1/2 -translate-y-1/2 font-bold top-1/2 left-1/2">
          Next
        </span>
      </button>
    </div>
