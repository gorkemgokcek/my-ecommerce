    ...
    return (
        <div className="flex justify-between border-1 border-gray-150 shadow-sm">
            <div className="product-card w-[328px] h-[604px] sm:w-[308px] sm:h-[580px] m-3 relative">
                <img src="products7.jpeg" className="object-cover" />
               {/*  sale button and cartshopping icon add */}
                <div className="flex-col text-left m-3">
                    <div className="flex justify-between mb-3">
                        ...
                        <button className="w-[50px] h-[26px] bg-[#252B42] text-white  text-xs leading-[16px] rounded-xl hover:bg-gray-400"><FontAwesomeIcon icon={faStar} style={{ color: "yellow" }} /> 4.6</button>
                    </div>
                    ...
                    <div className="flex gap-1 mb-3">
                        <h5 className="text-[#909090] text-[16px] leading-6 font-bold">$90.99</h5>
                        <h6 className="text-gray text-[16px] leading-6 font-bold">$78.99</h6>
                    </div>
                    <div className="flex gap-1 mb-3">
